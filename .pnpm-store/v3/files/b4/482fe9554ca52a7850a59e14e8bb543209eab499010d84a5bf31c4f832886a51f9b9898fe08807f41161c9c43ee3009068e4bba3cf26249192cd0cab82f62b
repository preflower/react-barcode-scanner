...
declare type ICompiler = (this: Pick<unified.Processor<unified.Settings>, 'data'>, node: Parameters<visit.Visitor<IDumiElmNode>>[0], index: Parameters<visit.Visitor<IDumiElmNode>>[1], parent: Parameters<visit.Visitor<IDumiElmNode>>[2], vFile: Parameters<Transformer>[1]) => ReturnType<visit.Visitor<IDumiElmNode>>;
