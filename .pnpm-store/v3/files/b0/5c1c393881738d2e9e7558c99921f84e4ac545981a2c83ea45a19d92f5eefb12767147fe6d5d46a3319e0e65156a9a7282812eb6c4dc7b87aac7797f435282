...
declare type OmitFromKnownKeys<T, K extends keyof T> = KnownKeys<T> extends infer U ? keyof U extends keyof T ? Pick<T, Exclude<keyof U, K>> & Pick<T, Exclude<keyof T, keyof KnownKeys<T>>> : never : never;
...
export declare type IPreviewerTransformerResult = {
    /**
...
export declare type IPreviewerTransformer = {
    /**
     * transformer type
