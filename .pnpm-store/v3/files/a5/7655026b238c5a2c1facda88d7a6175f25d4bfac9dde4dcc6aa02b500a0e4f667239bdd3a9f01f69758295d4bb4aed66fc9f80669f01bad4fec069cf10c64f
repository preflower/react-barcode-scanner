...
exports.getModuleResolvePkg = exports.getModuleResolvePath = exports.getModuleResolveContent = void 0;
...
const getModuleResolvePkg = ({
  ...
  const _getPkgPathsFromPath = getPkgPathsFromPath(resolvePath),
        ...
        absPkgModulePath = _getPkgPathsFromPath.absPkgModulePath; // use project path as module path for local packages
