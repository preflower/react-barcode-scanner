...
var relative = function relative(routes) {
  return routes.map(route => {
    if (route.component && !_path().default.isAbsolute(route.component)) {
      ...
      route.component = (0, _slash().default)(_path().default.relative( // ref: https://github.com/umijs/umi/blob/ef674b120c9a3188f0167a9fa2211d3cdbf60a21/packages/core/src/Route/Route.ts#L114
