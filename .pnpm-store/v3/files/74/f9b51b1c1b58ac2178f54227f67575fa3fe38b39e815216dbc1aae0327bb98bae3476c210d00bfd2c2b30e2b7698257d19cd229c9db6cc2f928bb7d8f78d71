...
function getFirstMenuInParent(childRoutes, customMenus) {
  ...
  const firstMenuItem = (customMenus === null || customMenus === void 0 ? void 0 : (_customMenus$0$childr = customMenus[0].children) === null || _customMenus$0$childr === void 0 ? void 0 : _customMenus$0$childr[0]) || (customMenus === null || customMenus === void 0 ? void 0 : customMenus[0]); // find first if user configured the first menu item for current nav/menu
